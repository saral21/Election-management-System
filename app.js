...
var admin = mongoose.model("Candidate",AdminSchema);
...
app.post("/login/admin",function(req,res){
	if(req.body.username=="PCCOE" && req.body.password=="MLSP"){
		res.redirect("/admin");
	}else{
...
app.post("/register",function(req,res){ 
	var base = req.body.email + req.body.adhaar;
	var code = crypto.createHash('md5').update(base).digest('hex');
	var aadh = parseInt(req.body.adhaar, 10);
	User.register(
			new User({
